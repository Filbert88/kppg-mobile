...
export default function ImageEditorScreen() {
  return (
    <SafeAreaView className="flex-1 bg-gray-200 py-20 gap-10 px-4">
      ...
      {/* Add Image Button */}
      <TouchableOpacity
        className="mx-4 mt-4 bg-rose-50 rounded-lg py-3 flex-row items-center justify-center"
        onPress={() => console.log('Add image pressed')}
      >
        <Text className="text-black font-black mr-2 text-2xl">+</Text>
        <Text className="text-black font-black text-2xl">Tambah Gambar</Text>
      </TouchableOpacity>
