...
// Import these if you're using react-native-svg for icons
// import { Clock, Plus, Vidfeo as VideoIcon, X, Play, Square, RotateCcw, CheckCircle, Trash2 } from 'react-native-feather';
...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'DiggingTime'>;
...
const DiggingTimePage = () => {
  ...
  const handleSave = () => {
    if (savedTime) {
      ...
      // Navigate or perform other actions after saving
    } else {
  ...
  const validateTimeInput = (text: string, setter: React.Dispatch<React.SetStateAction<string>>) => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-100">
      ...
      <ScrollView className="flex-1 px-6 pt-6">
          ...
          {videoFile ? (
            ...
            <View className="items-center">
              <View className="flex-row items-center mb-2">
                ...
                <Icon name="plus" size={20} color="#9ca3af" className="ml-2" />
              </View>
        ...
        {/* Digging Time */}
        <View className="mb-6">
          <Text className="text-xl font-bold mb-4 text-black">Digging Time</Text>

          {savedTime && (
            <View className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4 flex-row items-center justify-between">
              <View className="flex-row items-center">
                <Icon name="check-circle" size={20} color="#10b981" className="mr-3" />
                <View>
                  <Text className="text-green-800 font-medium">Time recorded</Text>
          ...
          >
            <Icon name="clock" size={18} color="#ffffff" className="mr-2" />
            <Text className="text-white font-medium">Mulai Stopwatch</Text>
          </TouchableOpacity>
          ...
          >
            <Icon name="plus" size={18} color="#374151" className="mr-2" />
            <Text className="text-gray-700 font-medium">Tambah Manual</Text>
          </TouchableOpacity>
        </View>
        ...
        <View className="items-center mt-6 mb-6">
          <TouchableOpacity
            className={`bg-green-700 py-3 px-4 rounded-md ${!savedTime ? 'opacity-50' : ''}`}
            onPress={handleSave}
            disabled={!savedTime}
          >
          ...
          <View className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <View className="p-6">
              ...
              <View className="flex-row flex-wrap mb-6">
                ...
                >
                  <Icon name="rotate-ccw" size={16} color="#374151" className="mr-2" />
                ...
                {!isRunning ? (
                  ...
                  >
                    <Icon name="play" size={16} color="#ffffff" className="mr-2" />
                  ...
                  >
                    <Icon name="square" size={16} color="#ffffff" className="mr-2" />
              ...
              >
                <Icon name="plus" size={16} color="#374151" className="mr-2" />
                <Text className="text-gray-700 font-medium">Simpan Waktu</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
                  ...
                  <React.Fragment key={i}>
                    <View className="items-center">
                      <TextInput
                        ...
                        onFocus={(e) => {
                          if (Platform.OS === 'web') {
                            // @ts-ignore - select() is available on web
                            e.target.select();
                          }
                        }}
