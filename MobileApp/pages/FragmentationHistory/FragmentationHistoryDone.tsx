    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.contentCard}>
          <Text style={styles.title}>Fragmentasi Batuan 1</Text>
          ...
          <View style={styles.imageAndInfoContainer}>
            ...
            <View style={styles.infoContainer}>
              <View style={styles.diggingTimeContainerNew}>
                ...
                <Text style={styles.diggingTimeValue}>07:23</Text>
              </View>
              ...
              <View style={styles.actionButtonsContainerNew}>
                <TouchableOpacity
                  ...
                  <Text style={styles.addPhotoButtonText}>+ Tambah Foto</Text>
                </TouchableOpacity>

                <TouchableOpacity
                  style={styles.depthAverageButton}
                  onPress={handleViewDepthAverage}>
          ...
          <View style={styles.graphAndSummaryContainer}>
            ...
            <View style={styles.summaryContainer}>
              <TouchableOpacity
                ...
                <Text style={styles.summaryButtonText}>Lihat Ringkasan</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
              ...
              {selectedItem && analysisData && (
                <View style={styles.statsContainer}>
                  ...
                  <View style={styles.statRow}>
                    ...
                    <Text style={styles.statValue}>
                      {analysisData.kuzram.percentage_above_60.toFixed(2)}%
                    </Text>
                  </View>
                  <View style={styles.statRow}>
                    <Text style={styles.statLabel}>% Below 60:</Text>
                    <Text style={styles.statValue}>
                      {analysisData.kuzram.percentage_below_60.toFixed(2)}%
                    </Text>
                  </View>
                  ...
                  {analysisData.threshold_percentages &&
                    Object.entries(analysisData.threshold_percentages).map(
                      ([key, value]) => (
...
const styles = StyleSheet.create({
  ...
  // New container for side-by-side layout of graph and summary button
